...
def create_starting_class_weapon_data(chr_init_param, rand_options):
    ...
    if rand_options.start_items_diff == rng_opt.RandOptStartItemsDifficulty.CRASH_SOULS:
        return return_list
